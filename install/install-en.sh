...
wget "https://github.com/wamuu-sudo/orchid/raw/main/testing/install-chroot-en.tar.xz" --output-document=install-chroot-en.tar.xz
tar -xvf "install-chroot-en.tar.xz" -C /mnt/orchid
